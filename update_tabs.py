...
new_content = r'''                <div class="flex flex-wrap justify-center solution-cards-container" style="gap: 2rem;">
                    ...
                    <div class="p-8 solution-card cursor-pointer hover:border-blue-500 flex flex-col" onclick="showDetail('it')" data-tab="it" style="width: 280px; min-height: 280px; background: #09131e; border: 1px solid rgba(255,255,255,0.03); border-radius: 12px; transition: all 0.3s ease;">
                        ...
                        <p class="text-gray-400 text-sm opacity-80 leading-relaxed mb-4 flex-grow">Enterprise technology and infrastructure procurement.</p>
                        <div class="mt-auto"><span class="explore-btn" style="color: #2563eb; font-size: 0.8rem; font-weight: 700; font-family: 'Inter', sans-serif;">EXPLORE <i class="fas fa-arrow-right ml-1"></i></span></div>
                    </div>
                    <!-- Card 6 -->
                    ...
                    <div class="p-8 solution-card cursor-pointer hover:border-blue-500 flex flex-col" onclick="showDetail('industrial')" data-tab="industrial" style="width: 280px; min-height: 280px; background: #09131e; border: 1px solid rgba(255,255,255,0.03); border-radius: 12px; transition: all 0.3s ease;">
                        ...
                        <p class="text-gray-400 text-sm opacity-80 leading-relaxed mb-4 flex-grow">Procurement of heavy machinery, equipment, and industrial parts.</p>
                        <div class="mt-auto"><span class="explore-btn" style="color: #2563eb; font-size: 0.8rem; font-weight: 700; font-family: 'Inter', sans-serif;">EXPLORE <i class="fas fa-arrow-right ml-1"></i></span></div>
                    </div>
                </div>
            </div>
        ...
        <script>
            const solutionsData = {
                logistics: {
                    ...
                    cards: [
                        {icon: 'fa-truck', title: 'Land Freight', desc: 'Secure and reliable heavy-duty ground transport spanning key regional hubs.'},
                ...
                it: {
                    ...
                    title: 'Enterprise <span class="gradient-text">IT Solutions</span>',
                    desc: 'From physical hardware drops to massive networking rollouts, our procurement engine ensures your digital foundations are flawless and future-proof.',
                    stats: [{val: '200+', label: 'Partners'}, {val: '50+', label: 'Categories'}, {val: '24/7', label: 'Support Readiness'}],
                    cards: [
                        {icon: 'fa-server', title: 'Network & Servers', desc: 'Data center racks, switches, and enterprise-grade networking components.'},
                        {icon: 'fa-laptop-code', title: 'Hardware Provisioning', desc: 'Bulk deployment of workstations, peripherals, and end-user devices.'},
                        {icon: 'fa-shield-alt', title: 'Security Appliances', desc: 'Access control hardware, surveillance, and physical IT security systems.'}
                    ]
                },
                hospitality: {
                    tag: 'HOSPITALITY',
                ...
                industrial: {
                    ...
                    desc: 'Expert procurement of massive machinery, intricate equipment, and specialized industrial components serving robust processing architectures.',
                    stats: [{val: '100+', label: 'Machines'}, {val: '20+', label: 'Categories'}, {val: '100%', label: 'Certified Specs'}],
                    cards: [
                        {icon: 'fa-cogs', title: 'Heavy Machinery', desc: 'High-yield manufacturing and raw construction systems.'},
                        {icon: 'fa-tools', title: 'Industrial Parts', desc: 'Critical supply line replacement components and operational spares.'},
                        {icon: 'fa-industry', title: 'Plant Equipment', desc: 'Logistics and scaling for massive industrial and plant integrations.'}
                    ]
                }
            };
